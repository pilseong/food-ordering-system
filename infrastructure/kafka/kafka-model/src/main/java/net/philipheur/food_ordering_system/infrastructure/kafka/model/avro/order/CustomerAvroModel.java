...
public class CustomerAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.CustomerAvroModel.Builder newBuilder() {
    return new net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.CustomerAvroModel.Builder();
  }
   ...
   * @return A new CustomerAvroModel RecordBuilder
   */
  public static net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.CustomerAvroModel.Builder newBuilder(net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.CustomerAvroModel.Builder other) {
    if (other == null) {
      return new net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.CustomerAvroModel.Builder();
    } else {
      return new net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.CustomerAvroModel.Builder(other);
    }
  }
   ...
   * @return A new CustomerAvroModel RecordBuilder
   */
  public static net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.CustomerAvroModel.Builder newBuilder(net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.CustomerAvroModel other) {
    if (other == null) {
      return new net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.CustomerAvroModel.Builder();
    } else {
      return new net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.CustomerAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CustomerAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.CustomerAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.CustomerAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.CustomerAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.CustomerAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.CustomerAvroModel.Builder setUsername(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.CustomerAvroModel.Builder clearUsername() {
      username = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.CustomerAvroModel.Builder setFirstName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.CustomerAvroModel.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.CustomerAvroModel.Builder setLastName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.CustomerAvroModel.Builder clearLastName() {
      lastName = null;
