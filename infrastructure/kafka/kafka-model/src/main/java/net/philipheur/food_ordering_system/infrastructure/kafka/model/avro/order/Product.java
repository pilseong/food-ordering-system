...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.Product.Builder newBuilder() {
    return new net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.Product.Builder newBuilder(net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.Product.Builder other) {
    if (other == null) {
      return new net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.Product.Builder();
    } else {
      return new net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.Product.Builder newBuilder(net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.Product other) {
    if (other == null) {
      return new net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.Product.Builder();
    } else {
      return new net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.Product.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.Product.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.Product.Builder clearQuantity() {
