...
public class PaymentResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentStatus paymentStatus;
   ...
   */
  public PaymentResponseAvroModel(java.util.UUID id, java.util.UUID sagaId, java.util.UUID paymentId, java.util.UUID customerId, java.util.UUID orderId, java.math.BigDecimal price, java.time.Instant createdAt, net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentStatus paymentStatus, java.util.List<java.lang.String> failureMessages) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 7: paymentStatus = (net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentStatus)value$; break;
   ...
   */
  public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentStatus getPaymentStatus() {
   ...
   * @param value the value to set.
   */
  public void setPaymentStatus(net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentStatus value) {
   ...
   */
  public static net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder newBuilder() {
    return new net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder();
  }
   ...
   * @return A new PaymentResponseAvroModel RecordBuilder
   */
  public static net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder newBuilder(net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder other) {
    if (other == null) {
      return new net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder();
    } else {
      return new net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder(other);
    }
  }
   ...
   * @return A new PaymentResponseAvroModel RecordBuilder
   */
  public static net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder newBuilder(net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel other) {
    if (other == null) {
      return new net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder();
    } else {
      return new net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentResponseAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder setSagaId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder setPaymentId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder clearPaymentId() {
      paymentId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder setCustomerId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder setOrderId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder setPrice(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder setPaymentStatus(net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder clearPaymentStatus() {
      paymentStatus = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder setFailureMessages(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentResponseAvroModel.Builder clearFailureMessages() {
    ...
    public PaymentResponseAvroModel build() {
      try {
        ...
        record.paymentStatus = fieldSetFlags()[7] ? this.paymentStatus : (net.philipheur.food_ordering_system.infrastructure.kafka.model.avro.order.PaymentStatus) defaultValue(fields()[7]);
